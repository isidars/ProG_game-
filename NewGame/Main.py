...
time.sleep(1)
print("UN "+Monster.name.upper()+"!!!! FUYEZ!!!!")
time.sleep(1)
...
print("Vous êtes attaqué par un monstre, c'est un "+Monster.name+"!\nIl a "+str(Monster.pv)+" point de vie.\nBonne chance !\n")
time.sleep(1)
#tant que le joueur ou le monstre on de la vie le combat continue
rejouer = "1"
while rejouer != "2":
    medicinal_plante = 5
    while Monster.nom > 0 and joueur1_pv > 0 and joueur_2 > 0:
        #le monstre à 2 choix attaque physique ou magique
        monster_choice=random.choice(["physique","magique"])
        if monster_choice == "physique":
            print(Monster.nom+" vous lance une attaque physique!")
            #On définie le taux d'esquive du joueur
            chance_esquive =int( 50 * (joueur1_esquive/Monster.vitesse))
            ...
            # le joueur a pas de chance il prend des degats mais reduit grace a sa défense
                ...
                print(Monster.name+" Vous à touché vous subissez "+ str(Monster.attaque-joueur1_defense)+" point de dégats")
                joueur1_pv = joueur1_pv - (Monster.attaque- joueur1_defense)
       #Le monstre choisi l'attaque magique
        elif monster_choice == "magique" and count_spell_monster >= 3:
            print("Le "+Monster.name+" crache du feu !!")
            count_spell_monster = 0
            chance_esquive =int(50*(joueur1_esquive/Monster.vitesse)*0.8)
            if chance_esquive < 10:
                chance_esquive = 10
            elif chance_esquive > 75:
                chance_esquive = 75
            ...
            # le joueur a pas de chance il prend des degats mais reduit grace a sa défense
                ...
                print(Monster.name + " Vous à touché vous subissez " + str(
                            Monster.attaque_magique - joueur1_defense_magique) + " point de dégats")
                joueur1_pv = joueur1_pv - (Monster.attaque_magique - joueur1_defense_magique)
        ...
        print(Monster.name + ":"+ str(Monster.pv) +"/" + str(Monster.pv_max))
        ...
        if action == "1":
            ...
            chance_esquive = int(50*(Monster.esquive/joueur1_vitesse))
            ...
            if test_attack < chance_esquive:
                ...
                print("Vous infligez "+str(joueur1_attaque-Monster.defense)+" dégats")
                Monster.pv = Monster.pv - (joueur1_attaque - Monster.defense)
       ...
       #Le joueur dispose de plusieur en fonction de son niveau
            ...
            chance_esquive = int(50 * (Monster.esquive / joueur1_vitesse)*0.5)
            if chance_esquive > 50:
                chance_esquive = 50
            test_attack = random.randint(1, 100)
            if test_attack < chance_esquive:
                ...
                print("Vous infligez " + str(joueur1_attaque_magique - Monster.defense_magique) + " dégats")
                Monster.pv = Monster.pv - (
                            joueur1_attaque_magique - Monster.defense_magique)
       ...
       #Si le joueur tape autre chose que "1" "2" ou "3" il passe son tour
        ...
        print(Monster.name+": "+str(Monster.pv)+"/"+str(Monster.pv_max)+" pdv\n\n")
    rejouer="2"
